                    ...
                    <tr key={run.trial_id} className="hover:bg-gray-50 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2 opacity-80 group-hover:opacity-100 transition-opacity">
                          ...
                          {/* Status Button */}
                          <button onClick={() => handleStatus(run)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-md transition-colors">
                            <Activity className="w-3.5 h-3.5" />
                            Status
                          </button>

                          {/* View Button */}
                          <button onClick={() => handleView(run)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 rounded-md transition-colors">
